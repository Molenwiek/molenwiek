...
<body>
  ...
  <div id="main">
    ...
    <div id="header">
      <div id="logo">
        <div id="logo_text">
          <h1>Molenwiek<span class="alternate_colour">'74</span></h1>
        </div>
      </div>
      <div id="menubar">
        <ul id="menu">
          <!-- put class="tab_selected" in the li tag for the selected page - to highlight which page you're on -->
          <li class="tab_selected"><a href="index.html">Teams</a></li>
    ...
    <div id="site_content">
      <div id="panel"><img src="panel.jpg" alt="tree tops" /></div>
      <div class="sidebar">
      ...
      <div id="content">
        ...
        <h1>Welcome to the tree_tops template</h1>
